...
func _stages() -> void:
	...
	check(patterns == [5, 12, 13], "Bosses must use distinct fan, crossing lane, and ring patterns")
	...
	check(challenge.hostile.count == 7, "Challenge must change the attack pattern")
